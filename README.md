...
```
В макете не отмечены четкие привязки-требования по состоянию
кнопок в состоянии ховера. Похоже, что в Ховере кнопка "Сбросить" должна менять цвет на #000000*,
но цвет текста изменить знакомыми способами не удается и реализация не описана в ТЗ.
Для видимости текста ставлю промежуточный цвет #787878.
